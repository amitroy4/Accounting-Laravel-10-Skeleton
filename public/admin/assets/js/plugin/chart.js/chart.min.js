...
!function() {
    ...
    t.prototype.afterDatasetsDraw = function(t) {
        this.parseOptions(t) && (this.labelBounds = [],
        ...
        for (var e = this.ctx, i = this.chartInstance, o = t._meta[Object.keys(t._meta)[0]], a = 0, s = 0; s < o.data.length; s++) {
            ...
            if (0 !== n.circumference || this.showZero) {
                ...
                default:
                    ...
                    this.showActualPercentages || 100 < (a += l) && (l -= a - 100,
                    l = parseFloat(l.toFixed(this.precision))),
                    h = l + "%"
                }
                ...
                if (e.save(),
                e.beginPath(),
                e.font = Chart.helpers.fontString(this.fontSize, this.fontStyle, this.fontFamily),
                "outside" === this.position || "border" === this.position && "pie" === i.config.type) {
                    var f, c = n.outerRadius / 2, p = this.fontSize + 2, d = n.startAngle + (n.endAngle - n.startAngle) / 2;
                    if ("border" === this.position ? f = (n.outerRadius - c) / 2 + c : "outside" === this.position && (f = n.outerRadius - c + c + p),
                    d = {
                        x: n.x + Math.cos(d) * f,
                        y: n.y + Math.sin(d) * f
                    },
    ...
    t.prototype.checkTextBound = function(t, e, i, o) {
        for (var a = this.labelBounds, s = 0; s < a.length; ++s) {
            ...
            for (n = [[r.left, r.top], [r.left, r.bottom], [r.right, r.top], [r.right, r.bottom]],
            h = 0; h < n.length; ++h)
                if (l = n[h][0],
                f = n[h][1],
                l >= t && l <= e && f >= i && f <= o)
    ...
    t.prototype.fillText = function(t, e, i) {
        var o = this.ctx;
        "object" == typeof t ? o.drawImage(t, e.x - t.width / 2, e.y - t.height / 2, t.width, t.height) : (o.fillStyle = i,
        o.textBaseline = "top",
        o.textAlign = "center",
    ...
    t.prototype.drawArcText = function(t, e, i, o) {
        ...
        r = i - n;
        var h = n += Math.PI / 2;
        if (n += ((i += Math.PI / 2) - ((s = this.measureText(t)).width / e + n)) / 2,
        o || !(i - n > r))
            if ("string" == typeof t)
                for (a.rotate(n),
                o = 0; o < t.length; o++)
